...
const projects = [
  ...
  { id: 'rams', title: 'Rams Studio', tag: 'Brand · Web', descKey: 'rams_desc', year: '2024–2026', theme: 'dark', bg: 'card-rams', url: 'https://rams.ae/' },
]

const skills = [
  { label: 'Primary', value: 'Figma' },
  { label: 'Design', value: 'UX/UI Systems' },
  { label: 'Craft', value: 'Typography' },
  { label: 'Suite', value: 'Adobe CC' },
  { label: 'Skill', value: 'Prototyping' },
  { label: 'Skill', value: 'UI Animation' },
  { label: 'Extra', value: 'Presentation Design' },
  { label: 'Tools', value: 'AI-augmented workflow' },
]

const marqueeItems = ['UX/UI Design', 'Product Design', 'Web Design', 'Graphic Design', 'Figma', 'Prototyping', 'Branding', 'Crypto & Web3', 'Mobile Apps', '4+ Years']
    ...
    <>
      ...
      <nav className={navScrolled ? 'scrolled' : ''} style={{
        ...
        <div className="nav-right">
          <div className="nav-social">
            <a href="https://t.me/bexvnd" target="_blank" rel="noreferrer" className="nav-social-link" onMouseEnter={addHover} onMouseLeave={removeHover}><IconTelegram /></a>
            <a href="https://www.linkedin.com/in/rzaevamir" target="_blank" rel="noreferrer" className="nav-social-link" onMouseEnter={addHover} onMouseLeave={removeHover}><IconLinkedIn /></a>
          </div>
          <div className="lang-switcher">
            {['en','ru'].map((l, i) => (
              <span key={l} style={{display:'flex',alignItems:'center',gap:'6px'}}>
                {i > 0 && <span className="lang-sep">/</span>}
                <button className={`lang-btn${lang === l ? ' active' : ''}`} onClick={() => setLang(l)} onMouseEnter={addHover} onMouseLeave={removeHover}>{l.toUpperCase()}</button>
              </span>
            ))}
          </div>
        </div>
      ...
      <section className="hero">
        ...
        <h1 className="hero-headline">
          {t.hero_line1}<br /><em>{t.hero_line2}</em> {t.hero_line3}<br />{t.hero_line4}
        </h1>
        <div className="hero-sub">
          <p className="hero-desc">{t.hero_desc}</p>
          <a href="#work" className="hero-cta" onClick={e => { e.preventDefault(); scrollTo('work') }} onMouseEnter={addHover} onMouseLeave={removeHover}>
          ...
          <div className="about-right reveal reveal-delay-2">
            <div className="skills-grid">
              {skills.map(({ label, value }) => (
                <div key={value} className="skill-item" onMouseEnter={addHover} onMouseLeave={removeHover}>
      ...
      <section className="contact" id="contact">
        <p className="contact-eyebrow reveal"><span className="section-num">04</span> {t.section_contact}</p>
        ...
        <div className="contact-links reveal">
          <a href="mailto:amirrzaeff@gmail.com" className="contact-link" onMouseEnter={addHover} onMouseLeave={removeHover}>
            <IconEmail />amirrzaeff@gmail.com<span>→</span>
          </a>
          <a href="https://t.me/bexvnd" className="contact-link" target="_blank" rel="noreferrer" onMouseEnter={addHover} onMouseLeave={removeHover}>
            <IconTelegram />Telegram<span>→</span>
          </a>
          <a href="https://www.linkedin.com/in/rzaevamir" className="contact-link" target="_blank" rel="noreferrer" onMouseEnter={addHover} onMouseLeave={removeHover}>
            <IconLinkedIn />LinkedIn<span>→</span>
          </a>
        </div>
      </section>
